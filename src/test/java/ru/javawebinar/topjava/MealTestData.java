...
public class MealTestData {
    public static final MatcherFactory.Matcher<Meal> MEAL_MATCHER = MatcherFactory.usingIgnoringFieldsComparator(Meal.class, "user", "id");
    ...
    public static final LocalDateTime END_DATE_TIME = of(2020, Month.JANUARY, 31, 0, 0);
    ...
    public static final List<MealTo> mealsToFiltered = MealsUtil.getFilteredTos(meals, SecurityUtil.authUserCaloriesPerDay(), START_DATE_TIME.toLocalTime(), END_DATE_TIME.toLocalTime());
